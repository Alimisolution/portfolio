...
function Hero() {
    ...
    return (
        <div id="home" className="w-full flex flex-col md:flex-row items-center justify-center gap-10 relative">
            ...
            {/* Image */}
            <motion.div className="flex-shrink-0" initial={{scale:0}} whileInView={{scale:1}} transition={{duration:1, type: "spring", stiffness: 100}}>
            ...
            <div className="flex-1 text-center md:text-left space-y-4">
                <motion.p initial={{opacity:0, y: -20}} whileInView={{opacity:1, y:0}} transition={{duration: 0.5, delay: 0.4}} className="md:text-xl text-lg font-medium text-slate-700 dark:text-slate-200">I'm <span className="font-bold text-blue-600 dark:text-blue-400">Alimi AbdulRosheed</span> (Alimisolution)</motion.p>
