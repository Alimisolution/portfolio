...
export default function About() {
  return (
    <div id="about" className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl p-4 md:p-8 flex flex-col md:flex-row items-center gap-8">
      <Image 
        src="/images/me-2.jpeg" 
        alt="about-me" 
        width={128}
        height={128}
        className="w-32 h-32 rounded-full object-cover ring-2 ring-blue-400 dark:ring-blue-600 shadow-md" 
      />
      <div className="flex-1 text-left">
        <motion.h1 
          ...
          viewport={{ once: true }} 
          className="md:text-4xl text-3xl mb-6 font-bold text-blue-700 dark:text-blue-400"
        >
          About Me
        </motion.h1>
        <motion.p 
          ...
          viewport={{ once: true }} 
          className="sm:text-lg text-base text-slate-700 dark:text-slate-200 mb-4"
        >
          My name is <span className='font-semibold text-blue-600 dark:text-blue-300'>Alimi AbdulRosheed</span> (Alimisolution). 
          I am a dedicated Software Engineer with 5 years of front-end and 3 years of back-end experience, specializing in Full-Stack and MERN-Stack development. 
          I have a proven track record of building high-quality, responsive web and mobile applications using modern technologies. 
          I am passionate about solving real-world problems through code, continuously learning, and delivering impactful digital solutions. 
